 ...
 *
 * ```js
 *   stax2.0Dev = angular.module('stax2.0Dev', ['stax2.0', 'ngMockE2E']);
 *   stax2.0Dev.run(function($httpBackend) {
...
!(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('stax2.0licationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('stax2.0', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('stax2.0licationModule'));
   *
   *
